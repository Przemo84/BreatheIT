...
const ReleaseMain = (props) => {
  ...
  return (
    <ImageBackground source={image} style={styles.releaseImageBackground}>
      ...
      <ButtonWithContentComponent onPress={() => props.navigation.navigate('ReleaseBioExcercise')}
        title='Bioenergotherapic Excercise'
        content='CBT-style diary to record the causes and consequences of episodes of anger. You are encouraged to record
        triggers, emotions, body sensations, thoughts, behaviours, and conssequences.'  />
      <ButtonWithContentComponent onPress={() => props.navigation.navigate('ReleaseYoga')}
        title='Yoga for Anger'
        content='Change your mental pattern and you change your emotion' />
    </ImageBackground>
  );
}
